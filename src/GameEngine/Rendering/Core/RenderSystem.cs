...
namespace GameEngine.Rendering.Core
{
    public class RenderSystem
    {
        ...
        /// <summary>
        /// When true (editor), renders to an off-screen framebuffer that GameViewWindow displays.
        /// When false (standalone game), renders directly to the default framebuffer (screen).
        /// </summary>
        public static bool UseFramebuffer { get; set; } = true;
